...
F {}
E {}
N 610 -510 770 -510 {lab=#net1}
N 610 -530 770 -530 {lab=#net1}
N 690 -530 690 -510 {lab=#net1}
N 610 -590 770 -590 {lab=VDD}
N 610 -450 770 -450 {lab=E}
N 690 -450 690 -440 {lab=E}
N 610 -370 610 -350 {lab=#net2}
N 770 -370 770 -350 {lab=#net3}
N 610 -290 770 -290 {lab=GND}
N 610 -430 770 -430 {lab=E}
N 690 -440 690 -430 {lab=E}
N -110 -280 -110 -260 {lab=NOT_B}
N -110 -340 -110 -310 {lab=VDD}
N -110 -230 -110 -200 {lab=GND}
N -150 -310 -150 -230 {lab=B}
N -160 -270 -150 -270 {lab=B}
N -110 -270 -100 -270 {lab=NOT_B}
N -110 -530 -110 -510 {lab=NOT_A}
N -110 -590 -110 -560 {lab=VDD}
N -110 -480 -110 -450 {lab=#net4}
N -150 -560 -150 -480 {lab=A}
N -160 -520 -150 -520 {lab=A}
N -110 -520 -100 -520 {lab=NOT_A}
N 130 -450 130 -430 {lab=#net5}
N 50 -530 210 -530 {lab=#net6}
N 50 -590 210 -590 {lab=VDD}
N 130 -530 130 -510 {lab=#net6}
N 130 -520 140 -520 {lab=#net6}
N 210 -590 350 -590 {lab=VDD}
N 350 -530 350 -510 {lab=L}
N 50 -590 50 -560 {lab=VDD}
N 210 -590 210 -560 {lab=VDD}
N 350 -590 350 -560 {lab=VDD}
N 310 -560 310 -480 {lab=#net6}
N 140 -520 310 -520 {lab=#net6}
N 350 -480 350 -450 {lab=#net4}
N 130 -400 130 -370 {lab=#net4}
N 160 -200 160 -180 {lab=#net7}
N 80 -280 240 -280 {lab=#net8}
N 80 -340 240 -340 {lab=VDD}
N 160 -280 160 -260 {lab=#net8}
N 160 -270 170 -270 {lab=#net8}
N 240 -340 380 -340 {lab=VDD}
N 380 -280 380 -260 {lab=G}
N 80 -340 80 -310 {lab=VDD}
N 240 -340 240 -310 {lab=VDD}
N 380 -340 380 -310 {lab=VDD}
N 340 -310 340 -230 {lab=#net8}
N 170 -270 340 -270 {lab=#net8}
N 380 -230 380 -200 {lab=GND}
N 160 -150 160 -120 {lab=GND}
N -110 -340 80 -340 {lab=VDD}
N -110 -200 -110 -120 {lab=GND}
N -110 -120 160 -120 {lab=GND}
N 350 -520 360 -520 {lab=L}
N 380 -270 390 -270 {lab=G}
N 690 -440 780 -440 {lab=E}
N -110 -590 50 -590 {lab=VDD}
N -110 -450 -110 -370 {lab=#net4}
N -110 -370 130 -370 {lab=#net4}
N 130 -370 350 -370 {lab=#net4}
N 350 -450 350 -370 {lab=#net4}
N 130 -480 260 -480 {lab=#net4}
N 260 -480 260 -370 {lab=#net4}
N 160 -120 620 -120 {lab=GND}
N 610 -590 610 -560 {lab=VDD}
N 770 -590 770 -560 {lab=VDD}
N 610 -320 610 -290 {lab=GND}
N 770 -320 770 -290 {lab=GND}
N 610 -400 660 -400 {lab=GND}
N 660 -400 660 -290 {lab=GND}
N 770 -400 890 -400 {lab=GND}
N 890 -400 890 -290 {lab=GND}
N 770 -290 890 -290 {lab=GND}
N 770 -480 890 -480 {lab=VDD}
N 890 -590 890 -480 {lab=VDD}
N 770 -590 890 -590 {lab=VDD}
N 380 -200 380 -120 {lab=GND}
N 160 -230 280 -230 {lab=GND}
N 280 -230 280 -120 {lab=GND}
N 350 -590 440 -590 {lab=VDD}
N 620 -120 700 -120 {lab=GND}
N 620 -120 710 -120 {lab=GND}
N 710 -290 710 -120 {lab=GND}
N 440 -590 610 -590 {lab=VDD}
...
C {lab_pin.sym} 120 -230 0 0 {name=p14 sig_type=std_logic lab=A}
C {lab_pin.sym} 120 -150 0 0 {name=p15 sig_type=std_logic lab=NOT_B}
...
C {lab_pin.sym} 570 -480 0 0 {name=p18 sig_type=std_logic lab=A}
C {lab_pin.sym} 730 -480 0 0 {name=p19 sig_type=std_logic lab=NOT_B}
