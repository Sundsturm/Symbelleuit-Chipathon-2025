...
N 0 -190 0 -160 {lab=VSS}
N -220 -110 -220 -80 {lab=VSS}
N -490 -300 -300 -300 {lab=VDD}
N -490 -160 -490 -80 {lab=VSS}
N -490 -80 -220 -80 {lab=VSS}
...
N 230 -280 230 -250 {lab=VSS}
N 390 -280 390 -250 {lab=VSS}
N 230 -360 280 -360 {lab=VSS}
N 280 -360 280 -250 {lab=VSS}
N 390 -360 510 -360 {lab=VSS}
N 510 -360 510 -250 {lab=VSS}
N 390 -250 510 -250 {lab=VSS}
N 390 -440 510 -440 {lab=VDD}
N 510 -550 510 -440 {lab=VDD}
N 390 -550 510 -550 {lab=VDD}
N 0 -160 0 -80 {lab=VSS}
N -220 -190 -100 -190 {lab=VSS}
N -100 -190 -100 -80 {lab=VSS}
N -30 -550 60 -550 {lab=VDD}
N 240 -80 320 -80 {lab=VSS}
N 240 -80 330 -80 {lab=VSS}
N 330 -250 330 -80 {lab=VSS}
...
C {lab_pin.sym} -30 -330 2 0 {name=p28 sig_type=std_logic lab=VSS}
