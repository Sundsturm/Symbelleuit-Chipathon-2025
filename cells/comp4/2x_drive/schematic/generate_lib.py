...
"""
        ...
        spice_content += f"""
* Device Under Test
Xdut VDD VSS B0 A0 B1 A1 L G E 2bit_comp_2x
...
"""
    ...
    def run_full_characterization(self, output_dir="prelayout_lib"):
...
def main():
    ...
    spice_file = "./2bit_comp_2x.spice"  # Change this to your actual file path
